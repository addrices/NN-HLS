...
//	const unsigned reps = 1;
	...
	C1:ConvLayer_NOPAD_Normal<Batch,C1_KSIZE,C1_SIZE,C1_INCHANNEL,C1_OUTCHANNEL,C1_INP,C1_MIDP_I,C1_MIDP_O,C1_OUTP,C1_STRIDE,WBIT,ABIT,C1_MBIT>(C1_in,C1_out,C1_W,C1_B,C1_SCALEBIT,reps);
	C2:ConvLayer_NOPAD_Normal_Gemm<Batch,C2_KSIZE,C2_SIZE,C2_INCHANNEL,C2_OUTCHANNEL,C2_INP,C2_MIDP_I,C2_MIDP_O,C2_OUTP,C2_STRIDE,WBIT,ABIT,C2_MBIT>(C1_out,C2_out,C2_W,C2_B,C2_SCALEBIT,reps);

	P2:MaxPool_IOP<P2_PSIZE,ABIT,P2_SIZE,P2_CHANNEL*Batch,P2_INP*Batch,P2_OUTP*Batch>(C2_out,P2_out,reps);
	C3:ConvLayer_NOPAD_Normal_Gemm<Batch,C3_KSIZE,C3_SIZE,C3_INCHANNEL,C3_OUTCHANNEL,C3_INP,C3_MIDP_I,C3_MIDP_O,C3_OUTP,C3_STRIDE,WBIT,ABIT,C3_MBIT>(P2_out,C3_out,C3_W,C3_B,C3_SCALEBIT,reps);
	P3:MaxPool_IOP<P3_PSIZE,ABIT,P3_SIZE,P3_CHANNEL*Batch,P3_INP*Batch,P3_OUTP*Batch>(C3_out,P3_out,reps);
	C4:ConvLayer_NOPAD_Normal_Gemm<Batch,C4_KSIZE,C4_SIZE,C4_INCHANNEL,C4_OUTCHANNEL,C4_INP,C4_MIDP_I,C4_MIDP_O,C4_OUTP,C4_STRIDE,WBIT,ABIT,C4_MBIT>(P3_out,C4_out,C4_W,C4_B,C4_SCALEBIT,reps);
	P4:MaxPool_IOP<P4_PSIZE,ABIT,P4_SIZE,P4_CHANNEL*Batch,P4_INP*Batch,P4_OUTP*Batch>(C4_out,P4_out,reps);
...
//const unsigned mbit = 16;
//const unsigned inchannel = 16;
//const unsigned outchannel = 32;
//const unsigned stride = 1;
//const unsigned size = 26;
//const unsigned inp = 4;
//const unsigned outp = 8;
//const unsigned midP = 4;
//void top(hls::stream<ap_uint<batch*abit*ksize*ksize> >& in,hls::stream<ap_uint<batch*abit*outp> >& out,unsigned reps = 1){
//	Conv_MulAct_Orbital_New<batch, ksize, wbit, abit, mbit, inchannel, outchannel, stride, size, inp, midP, outp>(in,out,C2_W,C2_B,reps);
//}
//void top(hls::stream<ap_uint<batch*abit*ksize*ksize> >& in,hls::stream<ap_uint<batch*abit*outp> >& out,unsigned reps = 1){
//	Conv_MulAct_Normal_Gemm<batch, ksize, wbit, abit, mbit, inchannel, outchannel, stride, size, inp, midP, outp>(in,out,C2_W,C2_B,reps);
//}
