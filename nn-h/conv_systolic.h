...
#pragma HLS UNROLL
								...
								MidArray[OChannel*Batch+k] += res((j*Batch+k+1)*MBit-1,(j*Batch+k)*MBit);
							}
						}
						// MidArray[(mpack*MidP)*Batch+0] += res((0*Batch+0+1)*MBit-1,(0*Batch+0)*MBit);
						// MidArray[(mpack*MidP)*Batch+1] += res((0*Batch+1+1)*MBit-1,(0*Batch+1)*MBit);
						// MidArray[(mpack*MidP)*Batch+2] += res((0*Batch+2+1)*MBit-1,(0*Batch+2)*MBit);
						// MidArray[(mpack*MidP)*Batch+3] += res((0*Batch+3+1)*MBit-1,(0*Batch+3)*MBit);
						// MidArray[(mpack*MidP)*Batch+4] += res((0*Batch+4+1)*MBit-1,(0*Batch+4)*MBit);
						// MidArray[(mpack*MidP)*Batch+5] += res((0*Batch+5+1)*MBit-1,(0*Batch+5)*MBit);
						// MidArray[(mpack*MidP)*Batch+6] += res((0*Batch+6+1)*MBit-1,(0*Batch+6)*MBit);
						// MidArray[(mpack*MidP)*Batch+7] += res((0*Batch+7+1)*MBit-1,(0*Batch+7)*MBit);

						// MidArray[(mpack*MidP+1)*Batch+0] += res((1*Batch+0+1)*MBit-1,(1*Batch+0)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+1] += res((1*Batch+1+1)*MBit-1,(1*Batch+1)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+2] += res((1*Batch+2+1)*MBit-1,(1*Batch+2)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+3] += res((1*Batch+3+1)*MBit-1,(1*Batch+3)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+4] += res((1*Batch+4+1)*MBit-1,(1*Batch+4)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+5] += res((1*Batch+5+1)*MBit-1,(1*Batch+5)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+6] += res((1*Batch+6+1)*MBit-1,(1*Batch+6)*MBit);
						// MidArray[(mpack*MidP+1)*Batch+7] += res((1*Batch+7+1)*MBit-1,(1*Batch+7)*MBit);
					
						// MidArray[(mpack*MidP+2)*Batch+0] += res((2*Batch+0+1)*MBit-1,(2*Batch+0)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+1] += res((2*Batch+1+1)*MBit-1,(2*Batch+1)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+2] += res((2*Batch+2+1)*MBit-1,(2*Batch+2)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+3] += res((2*Batch+3+1)*MBit-1,(2*Batch+3)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+4] += res((2*Batch+4+1)*MBit-1,(2*Batch+4)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+5] += res((2*Batch+5+1)*MBit-1,(2*Batch+5)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+6] += res((2*Batch+6+1)*MBit-1,(2*Batch+6)*MBit);
						// MidArray[(mpack*MidP+2)*Batch+7] += res((2*Batch+7+1)*MBit-1,(2*Batch+7)*MBit);

						// MidArray[(mpack*MidP+3)*Batch+0] += res((3*Batch+0+1)*MBit-1,(3*Batch+0)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+1] += res((3*Batch+1+1)*MBit-1,(3*Batch+1)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+2] += res((3*Batch+2+1)*MBit-1,(3*Batch+2)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+3] += res((3*Batch+3+1)*MBit-1,(3*Batch+3)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+4] += res((3*Batch+4+1)*MBit-1,(3*Batch+4)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+5] += res((3*Batch+5+1)*MBit-1,(3*Batch+5)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+6] += res((3*Batch+6+1)*MBit-1,(3*Batch+6)*MBit);
						// MidArray[(mpack*MidP+3)*Batch+7] += res((3*Batch+7+1)*MBit-1,(3*Batch+7)*MBit);

						// MidArray[(mpack*MidP+4)*Batch+0] += res((4*Batch+0+1)*MBit-1,(4*Batch+0)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+1] += res((4*Batch+1+1)*MBit-1,(4*Batch+1)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+2] += res((4*Batch+2+1)*MBit-1,(4*Batch+2)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+3] += res((4*Batch+3+1)*MBit-1,(4*Batch+3)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+4] += res((4*Batch+4+1)*MBit-1,(4*Batch+4)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+5] += res((4*Batch+5+1)*MBit-1,(4*Batch+5)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+6] += res((4*Batch+6+1)*MBit-1,(4*Batch+6)*MBit);
						// MidArray[(mpack*MidP+4)*Batch+7] += res((4*Batch+7+1)*MBit-1,(4*Batch+7)*MBit);

						// MidArray[(mpack*MidP+5)*Batch+0] += res((5*Batch+0+1)*MBit-1,(5*Batch+0)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+1] += res((5*Batch+1+1)*MBit-1,(5*Batch+1)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+2] += res((5*Batch+2+1)*MBit-1,(5*Batch+2)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+3] += res((5*Batch+3+1)*MBit-1,(5*Batch+3)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+4] += res((5*Batch+4+1)*MBit-1,(5*Batch+4)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+5] += res((5*Batch+5+1)*MBit-1,(5*Batch+5)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+6] += res((5*Batch+6+1)*MBit-1,(5*Batch+6)*MBit);
						// MidArray[(mpack*MidP+5)*Batch+7] += res((5*Batch+7+1)*MBit-1,(5*Batch+7)*MBit);

						// MidArray[(mpack*MidP+6)*Batch+0] += res((6*Batch+0+1)*MBit-1,(6*Batch+0)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+1] += res((6*Batch+1+1)*MBit-1,(6*Batch+1)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+2] += res((6*Batch+2+1)*MBit-1,(6*Batch+2)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+3] += res((6*Batch+3+1)*MBit-1,(6*Batch+3)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+4] += res((6*Batch+4+1)*MBit-1,(6*Batch+4)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+5] += res((6*Batch+5+1)*MBit-1,(6*Batch+5)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+6] += res((6*Batch+6+1)*MBit-1,(6*Batch+6)*MBit);
						// MidArray[(mpack*MidP+6)*Batch+7] += res((6*Batch+7+1)*MBit-1,(6*Batch+7)*MBit);

						// MidArray[(mpack*MidP+7)*Batch+0] += res((7*Batch+0+1)*MBit-1,(7*Batch+0)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+1] += res((7*Batch+1+1)*MBit-1,(7*Batch+1)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+2] += res((7*Batch+2+1)*MBit-1,(7*Batch+2)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+3] += res((7*Batch+3+1)*MBit-1,(7*Batch+3)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+4] += res((7*Batch+4+1)*MBit-1,(7*Batch+4)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+5] += res((7*Batch+5+1)*MBit-1,(7*Batch+5)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+6] += res((7*Batch+6+1)*MBit-1,(7*Batch+6)*MBit);
						// MidArray[(mpack*MidP+7)*Batch+7] += res((7*Batch+7+1)*MBit-1,(7*Batch+7)*MBit);
